    ...
    <>
      {isAuthenticated ? (
        ...
        <>
          ...
          <section className="bg-transparent hover:bg-[#ddd9ed]  shadow-xl flex  justify-center items-center rounded-xl flex-col px-8 py-6 mx-auto h-fit my-auto w-3/4 max-w-2xl text-black">
            <Outlet />
          </section>
        </>
      )}
